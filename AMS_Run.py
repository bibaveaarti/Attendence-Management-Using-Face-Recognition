    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def err_screen1():
                ...
                Label(errsc2, text='Please enter Student & Roll_no!!!', fg='red', bg='white',
            ...
            ENR = tk.Label(MFW, text="Enter Roll_no", width=15, height=2, fg="white", bg="blue2",
                           font=('times', 15, ' bold '))
            ...
            def create_csv():
                ...
                csv_name='A:/Demo/Attendance/Manually Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"A:/Demo/Attendance/Manually Attendance/-------Check atttendance-------"')
...
def err_screen():
    ...
    Label(sc1,text='Roll_no & Name required!!!',fg='red',bg='white',font=('times', 16, ' bold ')).pack()
...
def subjectchoose():
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"A:\Demo\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'aarti' :
            if password == 'aarti':
                ...
                cs = 'A:/Demo/StudentDetails/StudentDetails.csv/'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
lbl = tk.Label(window, text="Enter Roll_no", width=20, height=2, fg="black", bg="deep pink", font=('times', 15, ' bold '))
